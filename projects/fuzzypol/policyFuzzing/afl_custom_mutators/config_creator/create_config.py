...
if __name__ == "__main__": 
    ...
    # /fuzzing_resources/afl_custom_mutators/weighted_input_mutator
    # /fuzzing_resources/afl_custom_mutators/arg_and_file_input/rootlocation.txt
    # /fuzzing_resources/afl_custom_mutators/weighted_input_mutator/exprargs_transformed_input.txt
