...
int main (int argc, char* argv[]){
    ...
    seccomp_rule_add(ctx86_64, SCMP_ACT_LOG, 59, 0); // execve
    seccomp_rule_add(ctx86_64, SCMP_ACT_ALLOW, 30, 0); // shmat
    seccomp_rule_add(ctx86_64, SCMP_ACT_ALLOW, 31, 0); // shmctl
